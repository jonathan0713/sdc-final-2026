...
|---|---:|---|---:|---:|---:|---:|---:|
| Static Ego | `seq_1` | OK | 0.988666 | 0 | 0 | 114 | 409 |
| Moving Ego | `seq_3` | OK | 0.991226 | 0 | 0 | 85 | 356 |

### 7.3 Grid search 結果

本專案新增 `grid_search.py`，針對 baseline 的 `max_distance`, `max_age`, `min_hits` 做 public dev 搜尋。預設搜尋範圍：

```text
max_distance: 3.0, 4.0, 5.0, 6.0, 7.0
max_age: 3, 5, 8, 10
min_hits: 1, 2
```
...
| Competition | Dev Seq | Best `max_distance` | Best `max_age` | Best `min_hits` | MOTA-style score | IDSW proxy |
|---|---:|---:|---:|---:|---:|---:|
| Static Ego | `seq_1` | 7.0 | 8 | 1 | 0.988666 | 114 |
| Moving Ego | `seq_3` | 7.0 | 5 | 1 | 0.991226 | 85 |
